...
class SurvivorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survivor" do
    assert_difference('Survivor.count') do
      post survivors_url, params: { survivor: { age: @survivor.age, gender: @survivor.gender, last_latitude: @survivor.last_latitude, last_longitude: @survivor.last_longitude, name: @survivor.name } }, as: :json
    end
  ...
  test "should update survivor" do
    patch survivor_url(@survivor), params: { survivor: { age: @survivor.age, gender: @survivor.gender, last_latitude: @survivor.last_latitude, last_longitude: @survivor.last_longitude, name: @survivor.name } }, as: :json
    assert_response 200
  end
